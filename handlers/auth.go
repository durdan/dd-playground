...
func (ah *AuthHandler) Register(w http.ResponseWriter, r *http.Request) {
    ...
    ah.writeJSON(w, response, http.StatusCreated)
}
...
func (ah *AuthHandler) Login(w http.ResponseWriter, r *http.Request) {
    ...
    ah.writeJSON(w, response, http.StatusOK)
}

func (ah *AuthHandler) Profile(w http.ResponseWriter, r *http.Request) {
    user, ok := r.Context().Value("user").(*models.User)
    if !ok {
        ah.writeError(w, "User not found in context", http.StatusInternalServerError)
        return
    }

    ah.writeJSON(w, user, http.StatusOK)
}

func (ah *AuthHandler) writeJSON(w http.ResponseWriter, data interface{}, status int) {
